function homework(){
    ...
    <div class="topnav" id="myTopnav">
        ...
        <section id="section-b" class="grid">
            ...
            <li>
                <div class="card"><img src="/images/rem2.jpg" alt="">
                <div class="card-content">
                    <h3 class="class-title">Mobile App</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus inventore nemo quos sequi facilis laudantium dolorem perspiciatis, harum at accusamus!</p>
                    <button class="btn-isactive">Test</button>
                </div>
                </div>
            </li>
            <li>
                <div class="card"><img src="/images/rem3.jpg" alt="">
                <div class="card-content">
                    <h3 class="class-title">Marketing</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus inventore nemo quos sequi facilis laudantium dolorem perspiciatis, harum at accusamus!</p>
                </div>
                </div>
            </li>
